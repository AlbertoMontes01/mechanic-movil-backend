...
// verify stashes the exact raw bytes on req.rawBody alongside the parsed
// req.body -- the Lemon Squeezy webhook handler needs those raw bytes to
// check the HMAC signature (hashing the already-parsed-and-reserialized
// JSON wouldn't reliably match what Lemon Squeezy itself signed).
